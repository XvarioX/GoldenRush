...
import pl.xvariox.goldrush.entity.renderer.RevolverRenderer;
...
public class RevolverItem extends GoldRushModElements.ModElement {
	@ObjectHolder("gold_rush:revolver")
	...
	public RevolverItem(GoldRushModElements instance) {
		super(instance, 20);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RevolverRenderer.ModelRegisterHandler());
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 3f, 3, 5);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(Blocks.CRIMSON_FUNGUS, (int) (1));
		}
